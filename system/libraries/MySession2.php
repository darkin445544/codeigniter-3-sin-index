...
public function set_userdata($data){
   ...
   // $query = $this->db->get_where('session', $id_sistema);
    if($query->result_array()==$var){
    //mysqli_connect()

    //$sql="insert into session set id_sistema=$id_sistema,data=$data"
